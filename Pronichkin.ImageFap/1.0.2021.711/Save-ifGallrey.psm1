...
Save-ifGallrey
{
    ...
    process
    {
      ...
      # Remove invalid path characters (such as “:” or “/”) from gallery name
      ...
      # return $item.GetEnumerator() | Get-ifItem -Driver $Driver -Path $destination | Save-ifItem -Driver $Driver -Path $destination -Force:$Force
        ...
        return $item                 | Get-ifItem -Driver $Driver -Path $destination | Save-ifItem -Driver $Driver -Path $destination -Force:$Force
    }
}