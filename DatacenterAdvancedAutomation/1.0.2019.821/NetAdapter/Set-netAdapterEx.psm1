           ...
           #region 1/5  Adapter metadata (Name & Description)
               ...
               #region Set
                    ...
                    $NetworkAdapterPhysical | Sort-Object -Property 'PhysicalAddress' | ForEach-Object -Process {
                        ...
                        $Message = "  Processing physical network adapter `“$($psItem.Name)`”"
                        Write-Verbose -Message $Message
                        ...
                        )
                        {
                            ...
                            {
                                $PhysicalAddressString = $psItem.PhysicalAddress.ToUpper().Replace( ":", "-" ).TrimEnd()
                                $NetworkAdapterVmm     = $psItem
                            ...
                            {
                                $PhysicalAddressString = $psItem.LinkLayerAddress
                                $NetworkAdapterNative  = $psItem
                            }
...
Information updated $( ( Get-Date -DisplayHint DateTime ).DateTime )"
           ...
           #region 3/5  Template-based adapter configuration
              ...
              # Now we're going to loop through all network types defined in
              # Physical Computer Template (as “Physical Computer Network Adapter
              # Group Property”) and configure physical adapters as specified
