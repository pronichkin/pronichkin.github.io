        ...
        $ClusterProperty | ForEach-Object -Process {
           ...
           #region     Step II.    Deploy Cluster Nodes
             ...
             <# If
                ...
                $NodeCluster = Get-clusterNodeJob -Node $NodeCluster
                          ...
                          # Build the properties
                            ...
                            'Microsoft.SystemCenter.VirtualMachineManager.Host'
                            {
                                ...
                                )
                                {
                                    ...
                                    $applianceAddressString = Resolve-dnsNameEx -Name $HardwareProfileCurrent.applianceName                                    
                                    $applianceAddress       = [System.Uri]::new( 'https://' + $applianceAddressString )
                            ...
                            }
                            {
                              ...
                              # original Node properties in Cluster Properties.
                                ...
                                $AdapterParam = @{
                                    ...
                                    Node                        = $NodeCurrent
                                    NetworkAdapterGroupProperty = $HardwareProfileCurrent.NetworkAdapterGroupProperty
