                        ...
                        )
                        {
                            ...
                            {                    
                              ...
                              # $Name = $NetworkAdapterBmc.Slot + ' — ' + $NetworkAdapterBmc.Port
                                ...
                                If
                                (
                                    $NetworkAdapterBmc.Name
                                )
                                {
                                    $Message = "    Renaming to `“$( $NetworkAdapterBmc.Name )`”"
                                    Write-Debug -Message $Message

                                    $AdapterParam = @{

                                        InputObject = $NetworkAdapterNative
                                        NewName     = $NetworkAdapterBmc.Name
                                    }
                                    Rename-netAdapter @AdapterParam
                                }
                                Else
                                {
                                    $Message = "Network adapter `“$PhysicalAddress`” was found but no name is availabile in BMC or Device Naming property for Hyper-V virtual machine"
                                    Write-Warning -Message $Message
                                }
                            ...
                            'Microsoft.SystemCenter.VirtualMachineManager.HostNetworkAdapter'
                            {                        
                                $Description = "$($NetworkAdapterBmc.Name)
...
Information updated $( ( Get-Date -DisplayHint DateTime ).DateTime )"
                                ...
                                [System.Void]( Set-scvmHostNetworkAdapter @HostNetworkAdapterParam )
                            }
                        }
                    }
                                ...
                                )
                                {
                                    ...
                                    )
                                    {
                                      ...
                                      # Try to obtain Virtual Switch
                                        ...
                                        $VirtualNetwork = Get-scVirtualNetwork -vmHost $NodeCurrent |
                                      ...
                                      # Additional saftety measures in case we're dealing with a VM Host.
                                        ...
                                        )
                                        {
                                          ...
                                          # But first we need to recognize it in Vmm, thus refresh.
                                            ...
                                            $vmHostCurrent = Read-scvmHost -vmHost $NodeCurrent

                                            $NetworkAdapterTeam = Get-scvmHostNetworkAdapter -vmHost $NodeCurrent |
                                                Where-Object -FilterScript {
