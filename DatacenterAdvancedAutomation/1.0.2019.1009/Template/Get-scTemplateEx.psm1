   ...
   #region Code
        ...
        ( $psCmdlet.ParameterSetName )
        {
            'Physical'
            {
              ...
              # Build the Name for Physical Computer Template object in VMM
                ...
                )
                {
                    ...
                    $HostGroupParam.Add( 'NodeSetName', $NodeSetName )
                }
                ...
                $HostGroup = Get-scvmHostGroupEx @HostGroupParam
...

                {
                  ...
                  # straightforward of doing that is “Set-scVirtualHardDiskEx.ps1”                    
                    ...
                    $VirtualHardDiskParam = @{
                        ...
                        Signed         = $False  # Physical Computers cannot use Signed disks
                        vmmServer      = $vmmServer
                    }
                    $VirtualHardDisk = Get-scVirtualHardDiskEx @VirtualHardDiskParam
                 ...
                 <# Full hardware details of a physical computer are necessary
                    to create a custom resource with a diskpart script to clean
                    disks  #>
                  ...
                  # appropriate building blocks for the Profile in VMM.
                    ...
                    )
                    {
                        ...
                        $Script = Get-scLibraryItemEx @ScriptParam
                    ...
                    )
                    {
                     <# $CodeIntegrityPolicyParam = @{
                        ...
                        $CodeIntegrityPolicyParam = @{
                            ...
                            Manufacturer = $HardwareProfile.Manufacturer
                            Model        = $HardwareProfile.Model
                            vmmServer    = $vmmServer
                        }
                    ...
                    )
                    {
                      ...
                      # $Package = $Package | Where-Object -FilterScript { -Not [System.String]::IsNullOrWhiteSpace( $psItem.key ) }
            ...
            'Virtual'
            {
                ...
                Else
                {
                    $Message = "VM template `“$( $TemplateName )`” was not found"
