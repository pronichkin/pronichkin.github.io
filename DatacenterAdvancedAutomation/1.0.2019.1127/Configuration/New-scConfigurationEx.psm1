...
New-scConfigurationEx
{
   ...
   #region Code
      ...
      # Write-Verbose -Message "Physical Computer Template: $Template"
        ...
        If
        (
            [System.String]::IsNullOrWhiteSpace( $HostGroup )
        )
        {
            ...
            $HostGroup = Get-scvmHostGroupEx @GetscvmHostGroupExParam

            Write-Verbose -Message "VM Host Group: $HostGroup"
        }       
                    ...
                    )
                    {
                      ...
                      # Allocate Static IP address to the host
                        ...
                        )
                        {
                            ...
                            {
                                $Message = "  The IP Address specified is already allocated in the pool! A different static IP address from the pool will be used"
                                Write-Warning -Message $Message
                            }
                            Else
                            {                            
