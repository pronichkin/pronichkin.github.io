...
,
    ...
    Begin
    {
       ...
       #region Variable
            ...
            $InstanceCurrent = [System.Collections.Generic.Dictionary[        
                System.String,
                System.Collections.Generic.Dictionary[
                    System.String,
                    System.String
            ...
            )
            {
              ...
              # “-Verbose” switch is set explicitly to “False”
                ...
                Else
                {
                    $Message = "`“Site Name`” property (Fault Domain) for the current cluster node seem to be not defined. Set the Fault Domain, or restart the node to refresh information"
              ...
              # and matches the current node Fault Domain                
                ...
                $Instance.GetEnumerator() | Where-Object -FilterScript {
                    $psItem.Value[ 'SiteName' ] -eq $SiteName
                } | ForEach-Object -Process {
                    $InstanceCurrent.Add( $psItem.Key, $psItem.Value )
                }
          ...
          # $Date = Get-Date -Format FileDateTimeUniversal
            ...
            )
            {
                ...
                $Property.Add( [System.String]'AdminGroupName', [System.String]'bogus' )
    ...
    Process
    {  
        $InstanceCurrent.GetEnumerator() | ForEach-Object -Process {

           #region Parameter

                $Name             = $psItem.Key.Replace( '-', '_' )
                $NameNetwork      = $psItem.Key                
                $InstanceProperty = $psItem.Value
    ...
    "@  #>
                  ...
                  # Binary placing and service account parameter
                    ...
                    }
                    {
                       #region Feature-specific options
                            ...
                            If
                            (
                                $InstanceProperty[ 'EngineAccountName'      ] -or
                                $InstanceProperty[ 'AnalysisAccountName'    ]
                            )
                            {
                                $AgentAccount  = "$DomainAddress\$($InstanceProperty.AgentAccountName )"

                                $Parameter.Add( 'AgtSvcAccount'                ,  $AgentAccount     )                                

                                If
                                (
                                    $InstanceProperty[ 'AgentAccountPassword' ]
                                )
                                {
                                    $Parameter.Add( 'AgtSvcPassword'           ,  $InstanceProperty.AgentAccountPassword  )
                                }
                            }

                            If
                            (
                                $InstanceProperty[ 'EngineAccountName'      ]
                            )
                            {
                                $SqlServerParam = @{
                                ...
                                Else
                                {
                                    ...
                                    $EngineAccount = "$DomainAddress\$($InstanceProperty.EngineAccountName)"
        ...
        "@  #>
                                  ...
                                  # $Parameter.Add( 'iAcceptSqlServerLicenseTerms' ,  'True'          )
                                    ...
                                    If
                                    (
                                        $InstanceProperty[ 'EngineAccountPassword' ]
                                    )
                                    {
                                        $Parameter.Add( 'SqlSvcPassword'           ,  $InstanceProperty.EngineAccountPassword  )
                                    }
                                }
                            ...
                            )
                            {
                                ...
                                Else
                                {
                                    ...
                                    $AnalysisAccount = "$DomainAddress\$($InstanceProperty.AnalysisAccountName)"
        ...
        "@  #>
                                  ...
                                  # $Parameter.Add( 'iAcceptSqlServerLicenseTerms' ,  'True'             )
                                    ...
                                    If
                                    (
                                        $InstanceProperty[ 'AnalysisAccountPassword' ]
                                    )
                                    {
                                        $Parameter.Add( 'AsSvcPassword'            ,  $InstanceProperty.AnalysisAccountPassword   )
                                    }
                                }
                            ...
                            If
                            (
                                $InstanceProperty[ 'IntegrationAccountName' ]
                            )
                            {
                                $SqlServerParam = @{
                                ...
                                Else
                                {
                                    ...
                                    $IntegrationAccount = "$DomainAddress\$($InstanceProperty.IntegrationAccountName)"
        ...
        "@  #>
                                  ...
                                  # $Parameter.Add( 'iAcceptSqlServerLicenseTerms' ,  'True'                )
                                    ...
                                    If
                                    (
                                        $InstanceProperty[ 'IntegrationAccountPassword' ]
                                    )
                                    {
                                        $Parameter.Add( 'IsSvcPassword'            ,  $InstanceProperty.IntegrationAccountPassword   )
                                    }
                                }
                            ...
                            If
                            (
                                $InstanceProperty[ 'ReportingAccountName'   ]
                            )
                            {
                                Switch
                                (
                                ...
                                Else
                                {
                                  ...
                                  # installed by SQL Server setup engine
                                    ...
                                    $ReportingAccount  = "$DomainAddress\$($InstanceProperty.ReportingAccountName)"                                    
        ...
        "@  #>
                                  ...
                                  # $Parameter.Add( 'iAcceptSqlServerLicenseTerms' ,  'True'          )
                                    ...
                                    If
                                    (
                                        $InstanceProperty[ 'ReportingAccountPassword' ]
                                    )
                                    {
                                        $Parameter.Add( 'RsSvcPassword'            ,  $InstanceProperty.ReportingAccountPassword   )
                                    }                                    
                                }
                  ...
                  # Data placing parameter
                    ...
                    }
                    {
                       #region Feature-specific options
                            ...
                            {
                                $AdminGroup    = "$DomainAddress\$($InstanceProperty.AdminGroupName   )"
                            }
            ...
            "@  #>
                                ...
                                If
                                (
                                    $InstanceProperty[ 'saPassword' ]
                                )
                                {
                                     <# $AnswerFileContent += @"

            SECURITYMODE = "SQL"
            SAPWD = "$($InstanceProperty.saPassword)"

            "@  #>

                                    $Parameter.Add( 'SecurityMode'                 ,  'SQL'                             )
                                    $Parameter.Add( 'SaPwd'                        ,  $InstanceProperty.saPassword  )
                                }
                            }
        ...
        FailoverClusterIpAddresses="IPv4;$($InstanceProperty.ipAddress);$NetworkNameSite;$SubnetMask"
                    ...
                    )
                    {
                       #region Stand-alone SSRS/PBIRS installer
                            ...
                            'PBIRS'
                            {
                                ...
                                $ProductKey = $InstanceProperty.ProductKey
                            }
                            ...
                            }
                            {
                             ...
                             <# SSRS and PowerBI are installed from stand-alone
                                self-extracting setup, and hence it's not 
                                located in the same folder as regular SQL Server
                                installation media. Instead, it's assumed that
                                such arbitrary stand-alone files are located
                                one level up, in the generic Installation media
                                folder  #>

                                $PathParam = @{

                                    Path      = $Media.Parent.FullName
                                    ChildPath = $Setup
                                }
                              ...
                              # $Argument.Add( [System.String]::Empty  )
                               ...
                               #region Obtain Certificate

                                    If
                                    (
                                        $InstanceProperty[ 'ServiceName' ]
                                    )
                                    {
                                        $ServiceAddress = Resolve-dnsNameEx -Name $InstanceProperty.ServiceName
                                    }
                                    Else
                                    {
                                        $ServiceAddress = Resolve-dnsNameEx -Name $env:ComputerName
                                    }

                                    $FriendlyName = "SQL Server Reporting Services — $ServiceAddress"
                                    $SubjectName  = "CN=$ServiceAddress"

                                  # Try to find an existing certificate which matches our criteria.

                                    $Certificate = Get-ChildItem -Path 'Cert:\LocalMachine\My' |
                                        Where-Object -FilterScript {
            
                                            ( $psItem.FriendlyName -eq $FriendlyName ) -and
                                            ( $psItem.Subject      -eq $SubjectName  )
                                        }
                                    ...
                                    {
                                        Write-Verbose -Message 'Using existing certificate'
                                    }
                                    Else
                                    {
                                        Write-Verbose -Message 'Obtaining certificate'
                                      ...
                                      # We assume that if a Certificate Template Name was supplied
                                      # in Parameters, this means that we're using a trusted Certification
                                      # Authority to request Certificates.

                                        {
                                            $CertificateParam.Add(
                                    
                                                'TemplateName', $CertificateTemplateName
                                            )
                                        }
                                        $Certificate = Get-WebCertificate @CertificateParam
                                    }
                            
                                  # $CertificateThumbprint = $Certificate.Thumbprint.ToLower()

                               #endregion Obtain Certificate
                                    
                               #region Loopback protection for NTLM
                                    ...
                                    )
                                    {
                                        ...
                                        [System.Void]( New-ItemProperty @PropertyParam )
                                    }

                               #endregion Loopback protection for NTLM
                            }
