    ...
    {  
        $Instance | ForEach-Object -Process {
           ...
           #region Parameter
                ...
                $InstanceNameNetwork =  $InstanceParamCurrent.InstanceName                
                $InstanceAddress     = "$InstanceNameNetwork.$DomainAddress"
    ...
    "@  #>
        ...
        "@  #>
                            ...
                            )
                            {
                                ...
                                If
                                (
                                    ( Test-Product -Name $Name ) -eq 'Installed'
                                )
                                {
                                    $Message = "SQL Server Reporting Services `“$InstanceName`” is already installed. Skipping"
                                }
                                Else
                                {
                                    $Message = "Installing SQL Server Reporting Services `“$InstanceName`”"
        ...
        "@  #>
                    ...
                    }
                    {
                       #region Feature-specific options
                            ...
                            )
                            {
                                ...
                                Else
                                {
                                    $Message = "Configuring SQL Server Database Engine `“$InstanceName`”"
                                    Write-Verbose -Message $Message
                                  ...
                                  # $Feature.Add( 'SqlEngine' )
                                    ...
                                    {
                                        $EngineUserDbDir    =    "$EngineUserDbDirRoot\MSSQL$( $Version.value__ ).$InstanceName\MSSQL\DATA"
                                        $EngineUserDbLogDir = "$EngineUserDbLogDirRoot\MSSQL$( $Version.value__ ).$InstanceName\MSSQL\DATA"
                                        $EngineTempDbDir    =    "$EngineTempDbDirRoot\MSSQL$( $Version.value__ ).$InstanceName\MSSQL\DATA"
                                        $EngineTempDbLogDir = "$EngineTempDbLogDirRoot\MSSQL$( $Version.value__ ).$InstanceName\MSSQL\DATA"
            ...
            "@  #>
                            ...
                            )
                            {
                                ...
                                Else
                                {
                                    $Message = "Configuring SQL Server Analysis Service (SSAS) `“$InstanceName`”"
                                    Write-Verbose -Message $Message
        ...
        "@  #>
                      ...
                      # $Parameter.Add( 'iAcceptSqlServerLicenseTerms' ,  'True'                )
                        ...
                        $Parameter.Add( 'FailoverClusterGroup'         ,  $InstanceAddress      )
