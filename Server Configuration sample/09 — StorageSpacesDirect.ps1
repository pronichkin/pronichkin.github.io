...
$Mirror = New-Volume -StoragePool $StoragePool -FriendlyName 'Mirror'  -FileSystem CSVFS_ReFS -ResiliencySettingName 'Mirror' -NumberOfDataCopies 2 -ProvisioningType Fixed -Size 1tb -CimSession $cimSession[0]